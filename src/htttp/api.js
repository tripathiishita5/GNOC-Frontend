...
export const saveDailyAlertsApi = (data) => api.post("/alert", data);
export const getTodayAlertsApi = () => api.get("/alert");
export const getAllSavedAlertsApi = () => api.get("/alert/all");
